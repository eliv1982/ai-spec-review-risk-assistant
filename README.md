...
Владелец, аналитик и лицо, принимающее финальные решения — Елена. За ней остаются
продуктовые и архитектурные решения, а также приемка результата. AI-инструменты в
проекте — специализированные инженерные средства для реализации по заданным
спецификациям, а не автономные соавторы или владельцы проекта.

Цикл разработки: Спецификация → Реализация → Независимый аудит → Решение человека.
Каждая реализация проверялась независимым аудитом на соответствие исходной
спецификации; блокеры, регрессии, расхождения контрактов и риски, найденные на этом
этапе, устранялись до приемки. Финальные решения — приемка, изменение границ и
объема проекта — оставались за человеком.

Для реализации и независимой проверки использовались AI-ассистированные инструменты
разработки и ревью. Они не заменяли владельца проекта: спецификации, архитектурные
решения, оценка замечаний и финальная приемка оставались за человеком.
